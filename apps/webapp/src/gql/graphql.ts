...
export type NavbarMeQuery = {
  __typename?: "Query";
  me: { __typename?: "User"; id: string; role: Role };
};
...
export type VenuesInRangeQuery = {
  __typename?: "Query";
  venuesInRange: Array<{
    __typename?: "Venue";
    id: string;
...
export const NavbarMeDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "NavbarMe" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
...
} as unknown as DocumentNode<NavbarMeQuery, NavbarMeQueryVariables>;
export const VenuesInRangeDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "venuesInRange" },
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "GetVenuesInRangeInput" },
            },
          },
        },
      ],
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "isOwnedByMe" } },
...
} as unknown as DocumentNode<VenuesInRangeQuery, VenuesInRangeQueryVariables>;
export const ProfileMeDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "ProfileMe" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
...
} as unknown as DocumentNode<ProfileMeQuery, ProfileMeQueryVariables>;
export const DraftVenuesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "DraftVenues" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
...
} as unknown as DocumentNode<DraftVenuesQuery, DraftVenuesQueryVariables>;
