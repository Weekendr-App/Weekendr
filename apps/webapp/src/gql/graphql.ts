...
export type VenuePageQuery = { __typename?: 'Query', venue: { __typename?: 'Venue', id: string, name: string, latitude: number, longitude: number, isOwnedByMe?: boolean | null, picture: string, address: string } };
