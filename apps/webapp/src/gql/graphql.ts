...
export type VenuesInRangeQuery = { __typename?: 'Query', venuesInRange: Array<{ __typename?: 'Venue', id: string, name: string, picture: string, isOwnedByMe?: boolean | null, address: string, latitude: number, longitude: number, status: VenueStatus, events?: Array<{ __typename?: 'Event', id: string, category: { __typename?: 'Category', id: string, name: string, icon?: string | null } }> | null }> };
...
export type VenuesInRangeByCategoryQuery = { __typename?: 'Query', venuesInRangeByCategory: Array<{ __typename?: 'Venue', id: string, name: string, picture: string, isOwnedByMe?: boolean | null, address: string, latitude: number, longitude: number, status: VenueStatus, events?: Array<{ __typename?: 'Event', id: string, category: { __typename?: 'Category', id: string, name: string, icon?: string | null } }> | null }> };
